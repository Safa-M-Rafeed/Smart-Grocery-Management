    ...
    try {
        ...
        try {
          ...
          if (
            ...
            if (retryCount < maxRetries) {
              console.log(`Retry attempt ${retryCount} for duplicate order`);
      ...
      for (const result of orderItemsResults) {
        if (!result.ok) {
          ...
          throw new Error(errorData.message || "Failed to create order items");
        }
      }
      ...
      if (orderData.customer) {
        ...
        if (!loyaltyResponse.ok) {
          console.warn("Loyalty transaction failed, but order was successful");
        }
      }
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              >
                <Banknote
                  ...
                  className={`mx-auto mb-2 ${
                    paymentMethod === "cash" ? "text-primary1" : "text-gray-400"
                  }`}
                />
              ...
              >
                <CreditCard
                  size={24}
                  className={`mx-auto mb-2 ${
                    paymentMethod === "card" ? "text-primary1" : "text-gray-400"
                  }`}
                />
